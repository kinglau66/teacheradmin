...
import static com.king.teacher.web.rest.AccountResourceIT.TEST_USER_LOGIN;
import static org.assertj.core.api.Assertions.assertThat;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.*;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;

import com.king.teacher.IntegrationTest;
import com.king.teacher.config.Constants;
import com.king.teacher.domain.User;
import com.king.teacher.repository.AuthorityRepository;
import com.king.teacher.repository.UserRepository;
import com.king.teacher.security.AuthoritiesConstants;
import com.king.teacher.service.UserService;
import com.king.teacher.service.dto.AdminUserDTO;
import com.king.teacher.service.dto.PasswordChangeDTO;
import com.king.teacher.service.dto.UserDTO;
import com.king.teacher.web.rest.vm.KeyAndPasswordVM;
import com.king.teacher.web.rest.vm.ManagedUserVM;
...
class AccountResourceIT {
    ...
    void testRegisterValid() throws Exception {
        ...
        restAccountMockMvc
            .perform(post("/api/registers").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(validUser)))
    ...
    void testRegisterInvalidLogin() throws Exception {
        ...
        restAccountMockMvc
            .perform(post("/api/registers").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(invalidUser)))
    ...
    void testRegisterDuplicateLogin() throws Exception {
        ...
        // First user
        restAccountMockMvc
            .perform(post("/api/registers").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(firstUser)))
            .andExpect(status().isCreated());

        // Second (non activated) user
        restAccountMockMvc
            .perform(post("/api/registers").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(secondUser)))
            .andExpect(status().isCreated());
