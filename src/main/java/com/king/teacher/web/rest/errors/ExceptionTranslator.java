package com.king.teacher.web.rest.errors;
...
public class ExceptionTranslator implements ProblemHandling, SecurityAdviceTrait {
    ...
    public ResponseEntity<Problem> handleMethodArgumentNotValid(MethodArgumentNotValidException ex, @Nonnull NativeWebRequest request) {
        ...
        Problem problem = Problem
            ...
            .with(MESSAGE_KEY, ErrorConstants.ERR_VALIDATION)
            .with(MESSAGE, "Method argument not valid")
    ...
    public ResponseEntity<Problem> handleEmailAlreadyUsedException(
        com.king.teacher.service.EmailAlreadyUsedException ex,
    ...
    public ResponseEntity<Problem> handleUsernameAlreadyUsedException(
        com.king.teacher.service.UsernameAlreadyUsedException ex,
        NativeWebRequest request
    ) {
    ...
    public ResponseEntity<Problem> handleInvalidPasswordException(
        com.king.teacher.service.InvalidPasswordException ex,
        NativeWebRequest request
    ) {
    ...
    public ResponseEntity<Problem> handleConcurrencyFailure(ConcurrencyFailureException ex, NativeWebRequest request) {
        Problem problem = Problem.builder().withStatus(Status.CONFLICT).with(MESSAGE_KEY, ErrorConstants.ERR_CONCURRENCY_FAILURE).with(MESSAGE, "concurrency issue occurs").build();
        return create(ex, problem, request);
    }
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "javax.", "com.", "io.", "de.", "com.king.teacher");
    }
}
